...
module.exports = {
    ...
    "fullName": "@concatName(p.firstName^^text|.middleName^^text||>>AbdelMuti|#lastName^^text)",
    "bio":"article#bio^^data(bio)",
    "fullName_default": "@concatName(p.firstName^^text|.middleName^^text||@concatName(nonExistingProperty)||>>AbdelMuti|#lastName^^text)",
    "fullNameDefaultHardcoded": "@concatName(nonExistingProperty)||>>default",
    "fullName_withNotFoundMiddle": "@concatName(.firstName^^text|fullName.middleName|#lastName^^text)",
    ...
    "messaging": {
        ...
        "$mappings": {
            ...
            "type": "@getLinkType(li^^text|@getLinkService(li^^text,li^^attr(data-service)))",
            "value": "@cleanURI(li^^text|@getLinkType(li^^text,@getLinkService(li^^text,li^^attr(data-service))))??@getLinkType(li^^text|@getLinkService(li^^text,li^^attr(data-service)))#===#>>messaging"
        }
    },
    ...
    "social_media_addresses": {
        ...
        "$required": ["value"],
        "$mappings": {
            "value": "@transformTwitterHandle(li^^text)??li^^attr(data-service)#===#>>twitter"
        }
    },
